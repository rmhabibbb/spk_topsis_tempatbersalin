        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12   col-sm-12  col-md-12   col-lg-12 ">
                <ol class="breadcrumb breadcrumb-bg-cyan align-left">
                    <li><a href="<?=base_url()?>"><i class="material-icons">search</i> Tempat Praktek Bersalin</a></li> 
                </ol>
                <div class="card"> 
                        <div class="body">

                              <a data-toggle="modal" data-target="#filter" href="" style="text-decoration:none">
                            <div class="info-box-4 hover-zoom-effect">
                                <div class="icon">
                                    <i class="material-icons col-cyan">search</i>
                                </div>
                                <div class="content">
                                    <div class="text">-</div>
                                    <div class="number"> CARI TEMPAT PRAKTEK BERSALIN</div>
                                </div>
                            </div>
                        </a> 
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('beranda/cari')?>" method="Post" enctype="multipart/form-data"> 
