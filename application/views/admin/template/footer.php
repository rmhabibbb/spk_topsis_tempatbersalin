...
$(document).ready(function(){
  function newklinik(){ 
   ...
   $.ajax({
   url : "<?php echo base_url(); ?>admin/loadnklinik/?>", 
   cache : false,
...
<script type="text/javascript">
    jQuery(document).ready(function(){
      ...
      $('#id_klinik_datapenilaian').change(function(){ 
           $.ajax({
           url : "<?php echo base_url(); ?>admin/cekkecocokanfasilitas/?>",  
           method:"post", 
           data : {id : $(this).val()},
           cache : false,
           success : function(data){ 
              $("#nilai_fasilitas").html(data);     
           },
           }); 

           $.ajax({
           url : "<?php echo base_url(); ?>admin/cekkecocokanperawatan/?>",  
           method:"post", 
           data : {id : $(this).val()},
           cache : false,
           success : function(data){ 
              $("#nilai_perawatan").html(data);     
           },
           }); 
      });
