                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                         ...
                         <div class="row">
                            <form action="<?= base_url('alternatif/profil')?>" method="Post" id="editform2"> 
...
$(document).ready(function(){
   ...
   $("#editform2").change(function(){ 
        ...
        $.ajax({
                ...
                url:"<?php echo base_url(); ?>alternatif/cekpasslama",
                method:"post", 
                data:{pass},
          ...
          $.ajax({
                ...
                url:"<?php echo base_url(); ?>alternatif/cekpass",
                method:"post", 
                data:{pass1:pass1},
                    success:function(data){ 
                     if (data != ""){ 
          ...
          $.ajax({
                ...
                url:"<?php echo base_url(); ?>alternatif/cekpass2",
                method:"post", 
